...
int main()
{
    ...
    Texture t;
    t.loadFromFile("C:/Users/Valentin/Desktop/images/wiese.jpg");
    Sprite tiles(t);

    Texture sn;
    sn.loadFromFile("C:/Users/Valentin/Desktop/images/snake.png");
    Sprite snake(sn);

    Texture ap;
    ap.loadFromFile("C:/Users/Valentin/Desktop/images/aple.png");
    Sprite apple(ap);
    apple.setScale(0.2f, 0.2f); 

    Texture go;
    go.loadFromFile("C:/Users/Valentin/Desktop/images/ganeover.png");
    Sprite gameover(go);
